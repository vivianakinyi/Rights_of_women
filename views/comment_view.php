    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<?php if($query->num_rows() > 0): ?>
			...
			<!--To escape inapprpriate HTML inserted into comments use form_prep function-->
			 <div class="comment">
				<a href="#"><img src="<?php echo base_url();?>/assets/css/images/userpic.gif" width="40" height="40" alt="user" class="userpic" /></a>
				<p><?php echo stripslashes(form_prep($row->author));?> Says:<br /><?php echo stripslashes(form_prep (date('jS M Y',strtotime( $row->date)))); ?></p>
				<p><?php echo stripslashes(form_prep($row->body)); ?></p>
			</div>
			
				
				
			
				<p><?php //echo anchor('blog/comments/'.$row->post_id,'Comments'); ?></p>
				
				
			<?php endforeach; ?>
			
			<?php else :?>
				<p>No comment has been placed for this blog entry.</p>
				<hr />
		...
		<ol><li>
            ...
            <input id="name" name="author" class="text" />
          </li><li>
            <label for="message">Your Message</label>
            <textarea id="body" name="body" rows="8" cols="50"></textarea>
          </li><li>
		  
            <input type="submit"  src="<?php echo base_url();?>/assets/css/images/submit.gif" class="send" value="Submit" />
            <div class="clr"></div>
          </li></ol>
          </form>
