  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2>Categories of Women Rights</h2>
			
			
			<h3><?php echo anchor('topics/health_rights/','Health Rights'); ?></h3>
			<h3><?php echo anchor('topics/social_rights/','Social Rights'); ?></h3>
			<h3><?php echo anchor('topics/economic_rights/','Economic Rights'); ?></h3>
			<h3><?php echo anchor('topics/political_rights/','Political Rights'); ?></h3>
