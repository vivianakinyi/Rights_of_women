    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<?php foreach($query->result() as $row): ?>
			...
			<p><strong><?php echo anchor('blog/comments/'.$row->post_id,'Comments'); ?></strong>
			<?php  //$query = $this->db->query("SELECT * FROM comments WHERE post_id = ".$this->uri->segment(3)); echo $this->db->num_rows(); ?>
			(<?php $this->db->where('comment_id',$this->uri->segment(3)); echo $this->db->count_all('comments');?>) &nbsp;&nbsp;|&nbsp;&nbsp; 
			<?php echo date('jS M Y',strtotime( $row->date)); ?> &nbsp;&nbsp;|&nbsp;&nbsp; <?php echo anchor('blog/edit_post/'.$row->post_id,'Edit post');?></p>
        ...
        <div class="article">
		 ...
		 <?php echo form_open('blog/post_insert'); ?>
		...
		<ol><li>
            ...
            <input type="submit" id="submit" src="<?php echo base_url();?>/assets/css/images/submit.gif" class="send" value="Submit" />
            <div class="clr"></div>
          </li></ol>
          </form>
