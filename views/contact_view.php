  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Contact Us</h2>
          <p>If you need more informtion about us or need further assistance, feel free to contact us.We wiill be glad to reply your mail.</p>
        </div>
        <div class="article">
          <h2>Send us mail</h2>
		...
		<?php echo form_open('contact/send'); ?>
          ...
          <ol><li>
            ...
            <input id="name" name="name" class="text" value="<?php echo set_value('name'); ?>" />
          </li><li>
            <label for="email">Email Address (required)</label>
            <input id="email" name="email" class="text" value="<?php echo set_value('email'); ?>" />
          </li><li>
            <label for="message">Your Message</label>
            <textarea id="message" name="message" rows="8" cols="50"></textarea>
          </li><li>
            <input type="image" name="imageField" id="imageField" src="<?php echo base_url();?>/assets/css/images/submit.gif" class="send" />
            <div class="clr"></div>
          </li></ol>
          </form>
    ...
    <div class="fbg_resize">
      <div class="col c1">
        <h2><span>About</span></h2>
			<img src="<?php echo base_url();?>/assets/css/images/white.jpg" width="56" height="56" alt="pix" />        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec libero. Suspendisse bibendum. Cras id urna. Morbi tincidunt, orci ac convallis aliquam, lectus turpis varius lorem, eu posuere nunc justo tempus leo.  llorem, eu posuere nunc justo tempus leo. Donec mattis, purus nec placerat bibendum. <a href="#">Learn more...</a></p>
      </div>
      <div class="col c2">
