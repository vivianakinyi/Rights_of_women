      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="http://localhost/Rights/index.php/topics"><span><span>Topics</span></span></a></li>
		   <li><a href="http://localhost/Rights/index.php/links"><span><span>Links</span></span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h1>Information on Health Rights that Women should know</h1>
      ...
      <div class="sidebar">
        <div class="searchform">
				<?php $attributes = array('id'=>"formsearch", 'name'=>"formsearch");?>
				<?php echo form_open('topics/search',$attributes); ?>
				
					<input name="search" src="<?php echo base_url();?>/assets/css/images/search_btn.gif" class="button_search" type="image" />
